...
(()=>{
  ...
  draw();fetch('music-waves.json?v=lean-on-me-20260923',{credentials:'omit'}).then(r=>{if(!r.ok)throw Error('wave data');return r.json()}).then(v=>{data=v;sync();}).catch(()=>{canvas.remove();});
})();
